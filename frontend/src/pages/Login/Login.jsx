...
const Login = () => {
  ...
  return (
    <div className="relative w-full max-w-5xl flex flex-col md:flex-row rounded-[2xl] bg-[#121212]/70 backdrop-blur-2xl border border-white/10 shadow-[0_20px_50px_rgba(0,0,0,0.7)] z-10 overflow-hidden">
      ...
      <div className="w-full md:w-1/2 p-8 md:p-10 flex flex-col justify-center relative">
        ...
        <p className="text-xs text-gray-400 text-center mt-6 z-10">
          Chưa có tài khoản?{" "}
          <Link to="/register" className="text-white font-bold hover:text-[#1db954] transition-colors hover:underline underline-offset-4">
            Đăng ký ngay
          </Link>
        </p>
      </div>
